...
Desktop/iSeq/bowtie2-2.3.2-legacy/bowtie2-build -f $3 $3
...
(Desktop/iSeq/bowtie2-2.3.2-legacy/bowtie2 --local --minins 0 --maxins 2000 -x $3 -1 $1 -2 $2 -S $3.sam --al-conc $3.con.sam) 2>$3.stat.txt 
...
Desktop/iSeq/samtools-1.3.1/samtools view -bS $3.sam > $3.bam

# Sorted bam file
Desktop/iSeq/samtools-1.3.1/samtools sort $3.bam -o $3_sorted.bam

# Index _sorted.bam file
Desktop/iSeq/samtools-1.3.1/samtools index $3_sorted.bam

# Call variant
# samtools mpileup -ugf $3 $3_sorted.bam |bcftools call -vmO v -o $3_call.vcf

# Export pileup as wig using igvtools
Desktop/iSeq/IGVTools/igvtools count -z 1 -w 1 --bases $3_sorted.bam $3_sorted.wig $3
...
Desktop/iSeq/call.py $3_sorted.wig.csv $3 

# Generate consensus txt file
Desktop/iSeq/consensus.py $3_sorted.wig.csv
